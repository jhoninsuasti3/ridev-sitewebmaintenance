		...
		<div class="size1 p-l-15 p-r-15 p-t-30 p-b-50">
			<div class="flex-w flex-sb-m p-l-75 p-r-60 p-b-165 respon1">
				<div class="wrappic1 m-r-30 m-t-10 m-b-10">
					<a href="#"><img src="images/icons/logo.png" alt="LOGO RIWIN"></a>
				</div>
			...
			<div class="wsize1 m-lr-auto">
				...
				<form class="w-full flex-w flex-c-m validate-form">
					...
					<div class="wrap-input100 validate-input m-b-20" data-validate = "Un correo valido es requerido: ex@abc.xyz">
						<input class="input100 placeholder0 m1-txt1" type="text" name="email" placeholder="Aqui correo electronico">
				...
				<p class="txt-center s1-txt1 p-t-5">
					No te preocupes, tambien odiamos el spam, puedes desincribirte en cualquier momento
				</p>
			</div>
			...
			<div class="flex-w flex-c-m cd100 wsize1 m-lr-auto p-t-116">
				<div class="flex-col-c-m size2 bor1 m-l-10 m-r-10 m-b-15">
					<span class="l1-txt3 p-b-9 days">150</span>
					<span class="s1-txt2">Dias</span>
				</div>

				<div class="flex-col-c-m size2 bor1 m-l-10 m-r-10 m-b-15">
					<span class="l1-txt3 p-b-9 hours">17</span>
					<span class="s1-txt2">Horas</span>
				</div>

				<div class="flex-col-c-m size2 bor1 m-l-10 m-r-10 m-b-15">
					<span class="l1-txt3 p-b-9 minutes">50</span>
					<span class="s1-txt2">Minutos</span>
				</div>

				<div class="flex-col-c-m size2 bor1 m-l-10 m-r-10 m-b-15">
					<span class="l1-txt3 p-b-9 seconds">39</span>
					<span class="s1-txt2">Segundos</span>
				</div>
			</div>
		</div>
	</div>
